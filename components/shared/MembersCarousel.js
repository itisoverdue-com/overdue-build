...
import { PlayIcon, PauseIcon, ArrowLeftCircleIcon, ArrowRightCircleIcon } from "@heroicons/react/24/outline";
import Image from "next/image";
import SupportersData from "@/data/supportersData.js";
        ...
        <div className="flex flex-col w-full xl:px-12 overflow-hidden mt-12 md:mt-20">
            ...
            >
                {SupportersData.map(item => (
                    <div key={item.id} className="flex-none" style={{ width: `${ITEM_WIDTH}px` }}>
                        <Image
                            src={item.profile}
                            alt={item.name}
