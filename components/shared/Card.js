...
function generateClassName(variant, imgWidth) {
   ...
   const variantClasses = {
      text: `z-[1] w-full sm:w-[95%] max-w-[700px] py-6 px-8 sm:py-8 sm:px-14 shadow-[0_4px_12px_0_rgba(0,0,0,0.2)] text-left leading-8 bg-white text-base md:text-lg md:leading-10`,
